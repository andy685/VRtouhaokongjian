...
const routes: RouteRecordRaw[] = [
  ...
  // ===== 总运营后台（平台超管） =====
  {
    ...
    children: [
      ...
      { path: 'members/list', name: 'PlatformMembersList', component: () => import('../views/platform/MemberList.vue'), meta: { title: '会员卡列表' } },
  ...
  // ===== 商家后台（商家） =====
  {
    ...
    children: [
      ...
      { path: 'members', name: 'ShopMembers', component: () => import('../views/shop/Members.vue'), meta: { title: '会员卡列表' } },
      ...
      { path: 'on-demand-records', name: 'ShopOnDemandRecords', component: () => import('../views/shop/OnDemandRecords.vue'), meta: { title: '点播数据' } },
      ...
      // IC卡管理：功能暂隐（FEATURE_IC_CARD_ENABLED=false），恢复时取消注释
