...
const messages = ref<CpMessage[]>([
  { id: 1, title: '结算到账通知', content: '2026-05 结算周期已到账 ¥107,722（扣除手续费 ¥2,198），请查看结算记录。', time: '2026-05-28 10:30', type: 'financial', read: false },
  ...
  { id: 4, title: '结算到账通知', content: '2026-04 结算周期已到账 ¥66,679（扣除手续费 ¥1,361），请查看结算记录。', time: '2026-04-28 09:15', type: 'financial', read: true },
