...
const columns = [
  ...
  },
  {
    ...
    render: (row: any) =>
      h(NTag, { type: row.status === '成功' ? 'success' : 'error', size: 'tiny', bordered: true }, () => row.status),
  },
]

const loginLogs = ref([
  { time: '2026-05-31 10:25:33', ip: '113.88.xxx.xx', location: '广东深圳', device: 'Chrome / macOS', status: '成功' },
  { time: '2026-05-30 18:42:11', ip: '113.88.xxx.xx', location: '广东深圳', device: 'Chrome / macOS', status: '成功' },
  { time: '2026-05-30 09:15:44', ip: '113.88.xxx.xx', location: '广东深圳', device: 'Safari / iPhone', status: '成功' },
  { time: '2026-05-29 22:08:19', ip: '210.72.xxx.xx', location: '广东广州', device: 'Chrome / Windows', status: '成功' },
  { time: '2026-05-29 14:30:55', ip: '183.14.xxx.xx', location: '四川成都', device: '微信小程序', status: '失败' },
  { time: '2026-05-28 16:52:38', ip: '113.88.xxx.xx', location: '广东深圳', device: 'Chrome / macOS', status: '成功' },
  { time: '2026-05-28 09:08:21', ip: '113.88.xxx.xx', location: '广东深圳', device: 'Chrome / macOS', status: '成功' },
])
</script>
