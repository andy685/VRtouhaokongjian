<template>
  <div class="page-container ai-shop-sign-page">
    ...
    <template v-if="tab === 'devices'">
        ...
        <div class="content-card"><div class="card-title"><div><h2>设备管理</h2><p>展示已接入主机，按设备维护人设配置并查看 AI Token 用量。</p></div><n-button @click="message.success('已刷新设备列表')">刷新</n-button></div><n-data-table :columns="deviceColumns" :data="devices" :bordered="false" size="small" :scroll-x="isMerchant ? 1140 : 1360" /></div>
    </template>
