<template>
  <div class="page-container">
    <div class="page-header">
      <h1 class="page-title">游戏币调整有效期查询</h1>
      <n-space>
...
const columns = [
  ...
  { title: '调整类型', key: 'adjustType', width: 110, render: (row: any) => {
  ...
  { title: '涉及数量', key: 'amount', width: 80, align: 'center' as const },
  { title: '操作人', key: 'operator', width: 80 },
  { title: '调整时间', key: 'adjustTime', width: 155 },
  { title: '备注', key: 'remark', minWidth: 160, ellipsis: { tooltip: true } as any },
]

const tableData = ref([
  { id: 1, member: '赵天宇', phone: '177****9900', merchant: '华东展厅', storeName: '华东展厅', adjustType: 'extend', oldEffectiveDate: '2026-04-15', newEffectiveDate: '2026-04-15', oldExpireDate: '2027-04-15', newExpireDate: '2028-04-15', amount: 15000, operator: '管理员', adjustTime: '2026-04-20 14:32', remark: 'VIP客户续费补偿延长一年' },
  { id: 2, member: '阳恩', phone: '159****3344', merchant: '恒然集团', storeName: '恒然分部展厅', adjustType: 'reset', oldEffectiveDate: '2026-04-10', newEffectiveDate: '2026-01-01', oldExpireDate: '2026-10-10', newExpireDate: '2027-01-01', amount: 3600, operator: '运营-张三', adjustTime: '2026-04-19 16:20', remark: '重新设定有效期' },
  { id: 3, member: '张浩理', phone: '138****7890', merchant: '恒然集团', storeName: '恒然分部展厅', adjustType: 'extend', oldEffectiveDate: '2026-04-05', newEffectiveDate: '2026-04-05', oldExpireDate: '2027-01-05', newExpireDate: '2027-07-05', amount: 2000, operator: '店员-李四', adjustTime: '2026-04-18 11:08', remark: '活动奖励延期半年' },
  { id: 4, member: '李明远', phone: '136****3456', merchant: '幻影星空', storeName: '幻影星空馆 NO.8088', adjustType: 'shorten', oldEffectiveDate: '2026-03-28', newEffectiveDate: '2026-03-28', oldExpireDate: '2027-03-28', newExpireDate: '2026-09-28', amount: 6600, operator: '管理员', adjustTime: '2026-04-17 09:55', remark: '系统修正，原设置有误' },
  { id: 5, member: '王思琪', phone: '137****9012', merchant: '幻影星空', storeName: '幻影星空馆 NO.8088', adjustType: 'clear', oldEffectiveDate: '2026-02-15', newEffectiveDate: '--', oldExpireDate: '2026-05-15', newExpireDate: '--', amount: 270, operator: '管理员', adjustTime: '2026-04-15 13:42', remark: '账户异常，管理员手动清空' },
  { id: 6, member: '郑雨萱', phone: '135****6677', merchant: '华东展厅', storeName: '华东展厅', adjustType: 'extend', oldEffectiveDate: '2026-03-20', newEffectiveDate: '2026-03-20', oldExpireDate: '2027-03-20', newExpireDate: '2027-06-20', amount: 100, operator: '店员-王五', adjustTime: '2026-04-14 10:18', remark: '系统批量调整+3个月' },
  { id: 7, member: '陈晓峰', phone: '186****5566', merchant: '利民街商家', storeName: '利民街大展厅', adjustType: 'reset', oldEffectiveDate: '2026-02-10', newEffectiveDate: '2026-03-01', oldExpireDate: '2027-02-10', newExpireDate: '2027-03-01', amount: 2100, operator: '运营-张三', adjustTime: '2026-04-12 15:27', remark: '客户申请变更，重新设定' },
  { id: 8, member: '孙浩然', phone: '199****4455', merchant: '党建馆集团', storeName: '党建馆', adjustType: 'extend', oldEffectiveDate: '2026-03-15', newEffectiveDate: '2026-03-15', oldExpireDate: '2026-09-15', newExpireDate: '2026-12-15', amount: 4200, operator: '店员-李四', adjustTime: '2026-04-10 08:35', remark: '系统批量调整+3个月' },
])
