  ...
  <div class="page-container ai-report-page">
    ...
    <section class="filter-card" aria-label="报告筛选">
      <n-space :size="12" wrap>
        ...
        <n-select v-model:value="selectedMonth" clearable placeholder="全部周期" :options="monthOptions" style="width: 150px" aria-label="筛选报告周期" />
...
type Report = { id: number; title: string; store: string; merchant: string; month: string; periodType: '周度' | '月度' | '季度'; periodLabel: string; periodRange: string; version: string; score: number | null; status: string; merchantVisible: boolean; generatedAt: string; dataCutoff: string; summary: string; highlights: string[]; failureReason?: string }
...
const reports = ref<Report[]>([
  { id: 1, title: '深圳福田旗舰店 · AI 店铺经营诊断报告', store: '深圳福田旗舰店', merchant: '卓远娱乐', month: '2026-08', periodType: '月度', periodLabel: '2026 年 8 月', periodRange: '2026.08.01–08.31', version: 'v2.0', score: 82, status: '已生成', merchantVisible: true, generatedAt: '2026-09-05 10:24', dataCutoff: '2026-09-01 03:10', summary: '本月经营整体健康，营收与订单均高于上月。工作日晚间转化偏弱，建议优先改善高峰前设备巡检与套餐组合。', highlights: ['工作日 18:00 后订单转化低于周末 31%', '亲子双人套餐具备增长空间', '头显异常集中在高峰时段前后'] },
  { id: 2, title: '广州萝岗区店 · AI 店铺经营诊断报告', store: '广州萝岗区店', merchant: '卓远娱乐', month: '2026-08', periodType: '月度', periodLabel: '2026 年 8 月', periodRange: '2026.08.01–08.31', version: 'v1.0', score: 76, status: '已生成', merchantVisible: true, generatedAt: '2026-09-01 03:18', dataCutoff: '2026-09-01 03:15', summary: '营收保持稳定，但尾部游戏占用资源较多。建议优化内容陈列并以会员券推动复购。', highlights: ['两款尾部游戏点播占比不足 4%', '会员 30 天复购率有提升空间'] },
  { id: 3, title: '杭州滨江店 · AI 店铺经营诊断报告', store: '杭州滨江店', merchant: '幻境空间', month: '2026-08', periodType: '月度', periodLabel: '2026 年 8 月', periodRange: '2026.08.01–08.31', version: 'v1.0', score: 58, status: '已生成', merchantVisible: false, generatedAt: '2026-09-01 03:20', dataCutoff: '2026-09-01 03:18', summary: '设备异常与退款指标同时升高，建议优先检查设备状态和退款原因。', highlights: ['设备异常率高于区域均值', '退款金额环比上升'] },
  { id: 4, title: '成都春熙路店 · AI 店铺经营诊断报告', store: '成都春熙路店', merchant: '沉浸世界', month: '2026-07', periodType: '月度', periodLabel: '2026 年 7 月', periodRange: '2026.07.01–07.31', version: 'v1.0', score: 88, status: '已生成', merchantVisible: false, generatedAt: '2026-08-01 03:08', dataCutoff: '2026-08-01 03:05', summary: '营收、设备利用率和会员质量均表现良好，可沉淀套餐打法供同区域门店复用。', highlights: ['周末客单价高于区域均值', '设备可用率保持在 97%'] },
  { id: 5, title: '武汉光谷店 · AI 店铺经营诊断报告', store: '武汉光谷店', merchant: '沉浸世界', month: '2026-08', periodType: '月度', periodLabel: '2026 年 8 月', periodRange: '2026.08.01–08.31', version: '—', score: null, status: '生成失败', merchantVisible: false, generatedAt: '2026-09-01 03:26', dataCutoff: '2026-09-01 03:22', summary: '', highlights: [], failureReason: '设备利用率指标快照缺失，无法完成报告生成。' },
])
...
const columns = [
  ...
  { title: '周期', key: 'period', width: 150, align: 'left' as const, titleAlign: 'left' as const, render: (row: Report) => h('div', { class: 'period-cell' }, [h(NTag, { size: 'small', round: true, type: 'info' }, { default: () => row.periodType }), h('span', row.periodLabel)]) },
  { title: '数据范围', key: 'periodRange', width: 150, align: 'left' as const, titleAlign: 'left' as const },
...
.period-cell{display:flex;align-items:center;gap:8px;white-space:nowrap}.period-cell span{color:var(--text-secondary);font-variant-numeric:tabular-nums}
