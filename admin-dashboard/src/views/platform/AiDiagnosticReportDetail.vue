  ...
  <div class="report-page">
    ...
    <main class="report-shell">
      <section class="report-hero" :style="heroStyle">
        ...
        <div class="hero-heading"><h1>{{ report.store }}</h1><n-tag size="small" round class="hero-period-tag">{{ report.periodType }}</n-tag></div>
        <p>基于已固化的经营数据快照、诊断资料与报告模板自动生成。</p>
        <div class="hero-meta">
          <div><span>所属商家</span><strong>{{ report.merchant }}</strong></div>
          <div><span>数据范围</span><strong>{{ report.periodRange }}</strong></div>
...
const baseReport = Number(route.params.id) === 3
  ? { store: '杭州滨江店', merchant: '幻境空间', periodType: '月度', periodRange: '2026.08.01–08.31', generatedAt: '2026-09-01 03:20', dataCutoff: '2026-09-01 03:18', score: 58, level: '重点优化', merchantVisible: false, managerContext: '', conclusion: '本期设备异常与退款指标同时升高，建议先检查高峰前设备可用性和退款原因，再评估内容及套餐策略。', version: 'v1.0', template: '月度 AI 经营诊断报告', snapshot: '2026-09-01 03:18' }
  : { store: '深圳福田旗舰店', merchant: '卓远娱乐', periodType: '月度', periodRange: '2026.08.01–08.31', generatedAt: '2026-09-05 10:24', dataCutoff: '2026-09-01 03:10', score: 82, level: '健康增长', merchantVisible: true, managerContext: '暑期亲子活动延长至 22:00；本月有两台头显维修三天，高峰期曾出现短时设备不足。店长希望优先改善工作日晚间转化。', conclusion: '本月营收与订单均高于上月，周末亲子客群及会员储值复购是主要增长来源。《星际营救》《奇幻赛车》贡献了主要内容收入，但《深海探险》完成率偏低，应优先改善工作日晚间转化、设备保障和内容引导。', version: 'v2.0', template: '月度 AI 经营诊断报告', snapshot: '2026-09-01 03:10' }
