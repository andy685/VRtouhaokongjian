...
const logs = ref([
  ...
  { id: 4, scope: 'both', time: '2026-08-05 14:52:48', module: '会员资产', type: '储值调整', group: 'member', target: '会员：阳恩 159****3344', merchant: '恒然集团', store: '南山科技园店', operator: '官方运营后台', result: '成功', amount: -200, before: '预存剩余金额 ¥2,200', after: '预存剩余金额 ¥2,000', source: '总运营后台', ip: '120.229.66.18', terminal: 'Windows Edge', bizNo: 'ADJ-202608051452', remark: '异常充值回滚' },
  { id: 5, scope: 'platform', time: '2026-08-05 14:30:18', module: '内容分发', type: '内容分发', group: 'system', target: '游戏：过山车VR v2.3.2', merchant: '全平台', store: '156 家店铺', operator: '官方运营后台', result: '处理中', amount: 0, before: '已分发 v2.3.1', after: '分发 v2.3.2', source: '总运营后台', ip: '120.229.66.18', terminal: 'Windows Edge', bizNo: 'DIST-202608051430', remark: '一键全发任务' },
  ...
  { id: 10, scope: 'platform', time: '2026-08-04 16:40:22', module: '账号权限', type: '权限变更', group: 'system', target: '角色：店长', merchant: '全平台', store: '全部店铺', operator: '官方运营后台', result: '成功', amount: 0, before: '无退款审核权限', after: '增加退款审核权限', source: '总运营后台', ip: '120.229.66.18', terminal: 'Windows Edge', bizNo: 'ROLE-202608041640', remark: '统一权限模板更新' },
])
