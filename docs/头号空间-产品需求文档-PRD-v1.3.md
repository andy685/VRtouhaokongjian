...
> **版本**: v2.0 统一版
> **日期**: 2026年6月13日
> **状态**: 统一发布（合并支付、对账、分账、结算、退款与财务链路规则）
> **密级**: 内部公开
> **作者**: 产品团队
...
| 优惠券/活动优惠 | 商家自行创建的减免权益 | 否 | 先优惠，再计算会员资产和外部支付；第一版无平台券 |
...
| 代理商分润 | 第一版只实现游戏豆采购分润，不实现商家交易流水或平台服务费分润 |
...
如果游戏豆采购订单退款或撤销，按采购流水冲减代理商分润。C端消费订单退款不直接冲减代理商分润，除非同时触发游戏豆采购退款。
