...
> **版本**: v2.8
> **日期**: 2026年6月26日
> **状态**: 新增异常订单标记/取消标记、对账中心驳回/重提交互流程 — 商家端6类订单+对账中心支持标记、取消标记；平台端异常汇总支持通过/退款/驳回审核、驳回原因必填；商家端驳回订单展示驳回原因、支持修正后重新提交
> **密级**: 内部公开
> **作者**: 产品团队
...
> 平台对账中心汇总商家提交的异常订单，平台运营/财务可进行审核：通过、退款或驳回。
...
| 退款 | `pending/escalated → resolved` | 无 |
