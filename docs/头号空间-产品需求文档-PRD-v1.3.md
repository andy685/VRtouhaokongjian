...
| 💰 **平台财务** | 营收总览、游戏豆销售、商家结算、代理商结算、阶梯策略配置、打款管理、对账中心、拉卡拉配置 |
...
| ⚙️ **拉卡拉配置** | 管理拉卡拉分账账户配置，支持平台/商家/门店/代理商/游戏供应商五种归属类型的分账主体参数 | 超管/财务 |
...
| 📈 **财务报表** | 各类统计报表 | 超管/财务 |
| ⚙️ **拉卡拉配置** | 配置拉卡拉分账账户信息（归属类型、商户号、终端号、虚拟终端号、渠道号、机构号、分账接收方、钱包账户号）；支持按归属类型和状态筛选；归属对象根据归属类型动态联动下拉 | 超管/财务 |
...
> 📎 v2.9 更新: 新增拉卡拉配置管理页面（§4.8.4/§4.8.5），支持平台/商家/门店/代理商/游戏供应商五种归属类型的拉卡拉分账账户配置（商户号、终端号、虚拟终端号、渠道号、机构号、分账接收方、钱包账户号），归属对象根据归属类型动态联动下拉；平台端订单流水页（OrderFlow.vue）移除退款按钮，退款权限完全归商家后台（玩家在商家现场，只有商家能确认并执行退款）；异常订单审核（§4.8.4.2）简化审核选项为已解决/驳回两项
